export default {
  ...
  alert: {
    cloud: {
      ...
      descOnMobile:
        'We provide {{credit}} free computing credits for all registered users, ready to use without complex configuration.',
      title: 'Launch {{name}}',
    },
  },
  appLoading: {
    ...
    failed:
      'Sorry, the application initialization failed. Please check the details for troubleshooting.',
  ...
  clientDB: {
    ...
    modal: {
      desc: 'Activate the next-generation client database now. Persistently store your chat data in your browser and unlock advanced features like the Knowledge Base.',
      enable: 'Enable Now',
      features: {
        knowledgeBase: {
          desc: 'Build your personal knowledge base and easily start conversations with your assistant using it (coming soon).',
          title: 'Knowledge Base Support — Unlock Your Second Brain',
        },
        localFirst: {
    ...
    solve: {
      backup: {
        ...
        reset: {
          alert: 'Warning',
          alertDesc:
            'The following actions may result in data loss. Please ensure you have backed up important data before proceeding.',
  ...
  lang: {
    'ar': 'Arabic',
    'auto': 'Follow system language settings',
    'bg-BG': 'Bulgarian',
    'bn': 'Bengali',
    'cs-CZ': 'Czech',
    'da-DK': 'Danish',
