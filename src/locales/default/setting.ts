export default {
  ...
  defaultAgent: {
    model: {
      desc: 'Default model used when creating a new Agent',
      title: 'Model',
    },
    title: 'Default Assistant Settings',
  },
  group: {
  ...
  header: {
    ...
    group: 'Team Settings',
    groupDesc: 'Manage group and chat preferences',
  ...
  llm: {
    ...
    customModelCards: {
      ...
      modelConfig: {
        ...
        functionCall: {
          extra:
            "This configuration will only enable function calling capabilities within the application. Whether function calling is supported depends entirely on the model itself; please test the model's function calling capabilities on your own.",
        ...
        vision: {
          extra:
            "This configuration will only enable image upload capabilities within the application. Whether recognition is supported depends entirely on the model itself; please test the model's visual recognition capabilities on your own.",
  ...
  marketPublish: {
    modal: {
      ...
      identifier: {
        extra:
          'The identifier serves as the unique ID for the agent. Use lowercase letters, numbers, and hyphens.',
      ...
      messages: {
        ...
        missingIdentifier: 'This assistant does not have a community identifier yet.',
        notAuthenticated: 'Please log in to your community account first.',
        publishFailed: 'Publish failed: {{message}}',
      },
      submitButton: 'Publish',
      title: {
        submit: 'Share to Assistant Community',
        upload: 'Publish New Version',
      },
    },
    resultModal: {
      message:
        'Your assistant has been submitted for review. It will go live automatically once approved.',
      title: 'Submission Successful',
      view: 'View in Community',
    },
    submit: {
      button: 'Share to Community',
      tooltip: 'Share your assistant with the community',
    },
    upload: {
      button: 'Publish New Version',
      tooltip: 'Publish a new version to the Assistant Community',
    },
  },
  memory: {
    enabled: {
      desc: 'When enabled, the AI will remember your preferences from the conversation history, accumulate memories, and use them as references in future interactions.',
      title: 'Enable Memory',
    },
  ...
  myAgents: {
    actions: {
      ...
      deprecate: 'Deprecate Permanently',
      ...
      deprecateConfirmTitle: 'Confirm Deprecate Agent?',
      deprecateError: 'Failed to deprecate agent',
      deprecateLoading: 'Deprecating agent...',
      deprecateSuccess: 'Agent deprecated',
      edit: 'Edit Agent',
      publish: 'Publish Agent',
      publishError: 'Failed to publish agent',
      publishLoading: 'Publishing agent...',
      publishSuccess: 'Agent published',
      unpublish: 'Unpublish Agent',
      unpublishError: 'Failed to unpublish agent',
      unpublishLoading: 'Unpublishing agent...',
    ...
    empty: {
      description: "You haven't published any assistants to the market yet",
      title: 'No Published Assistants',
    },
    errors: {
      editFailed: 'Failed to edit agent, please try again later',
      fetchFailed: 'Failed to fetch agent details',
      notAuthenticated: 'Please sign in to your market account first',
    },
    loginRequired: {
      button: 'Sign in to Market',
      description: 'Please sign in to your market account to view your published assistants',
  ...
  settingAgent: {
    avatar: {
      sizeExceeded: 'Image size exceeds 1MB limit, please choose a smaller image',
      title: 'Avatar',
    },
    backgroundColor: {
    ...
    prompt: {
      placeholder: 'Enter assistant settings, press / to open the command menu',
      title: 'Assistant Settings',
    },
    submit: 'Update Assistant Information',
    tag: {
      desc: 'Assistant tags will be displayed in the Assistant Community',
  ...
  settingCommon: {
    devMode: {
      desc: 'Enable to show developer-related features and options',
    ...
    liteMode: {
      desc: 'Enable to simplify the interface and hide advanced features',
      title: 'Lite Mode',
    },
    responseLanguage: {
      auto: 'Follow System',
      desc: 'Set the language for AI responses',
  ...
  settingGroup: {
    ...
    submit: 'Update Team',
    systemPrompt: {
      placeholder: 'Please enter the host system prompt',
      title: 'Host System Prompt',
    },
    title: 'Group Information',
  },
  settingGroupChat: {
    allowDM: {
      desc: 'When turned off, you can still send direct messages to the assistant',
      title: 'Allow Direct Messages from Assistant',
    },
    enableSupervisor: {
      desc: 'Enable the group moderator feature to manage team conversations',
      title: 'Enable Host',
    },
    maxResponseInRow: {
      desc: 'Select how many consecutive messages a member can reply with. Set to 0 to disable this limit.',
      title: 'Consecutive Reply Count',
    },
    model: {
      desc: "Group members' messages will not be affected. Some models cannot be used as host models.",
      title: 'Host Model',
    },
    orchestratorTitle: 'Host Settings',
    responseOrder: {
      desc: 'Agents will respond in the order set in the chat',
      options: {
        natural: 'Natural',
        sequential: 'Sequential',
      },
      placeholder: 'Select reply order',
      title: 'Reply Order',
    },
    responseSpeed: {
      desc: 'Control the overall pace of the conversation',
      options: {
        fast: 'Fast',
        medium: 'Medium',
        slow: 'Slow',
      },
      placeholder: 'Select reply speed',
      title: 'Reply Speed',
    },
    revealDM: {
      desc: 'Make private messages sent to other members visible to you.',
      title: 'Show Private Messages',
    },
    submit: 'Update Settings',
    systemPrompt: {
      desc: 'Custom system prompt for the group chat host. This may affect the default host behavior.',
      placeholder: 'Please enter a custom host system prompt...',
      title: 'Host System Prompt',
    },
    title: 'Chat Settings',
  },
  settingGroupMembers: {
    ...
    disableHost: 'Disable Host Assistant',
    edit: 'Edit Member',
    empty: 'There are no members in this team yet. Click the + button to add members.',
    enableHost: 'Enable Host Assistant',
    groupHost: 'Group Host',
    groupMembers: 'Group Members',
    host: {
      description:
        'When the host is in the group, the chat runs automatically, suitable for brainstorming tasks.',
      title: 'Host',
    },
    noAvailableAgents: 'No available assistants',
    noDescription: 'No description',
    noMembersInGroup: 'No members in the group',
    owner: 'You (Owner)',
  ...
  settingOpening: {
    openingMessage: {
      ...
      placeholder:
        'Hello, I am your Custom Assistant. You can start chatting with me right away, or go to Assistant Settings to complete my information.',
      title: 'Opening Message',
    },
    openingQuestions: {
      desc: 'Guiding questions displayed at the beginning of the conversation',
      empty: 'Add opening questions to help users start the conversation quickly',
  ...
  submitAgentModal: {
    ...
    metaMiss:
      'Please complete the assistant information before submitting. It should include name, description, and tags',
    placeholder: 'Enter a unique identifier for the assistant, e.g. web-development',
    success: 'Assistant submitted successfully',
    tooltips: 'Share to Assistant Community',
  },
  submitFooter: {
    reset: 'Reset',
    submit: 'Save',
  ...
  systemAgent: {
    agentMeta: {
      ...
      title: 'Assistant Info Generation Helper',
    },
    customPrompt: {
    ...
    generationTopic: {
      ...
      title: 'AI Art Topic Naming Assistant',
    },
    helpInfo:
      'When creating a new assistant, the default assistant settings will be used as preset values.',
    historyCompress: {
      label: 'Model',
      modelDesc: 'Specify the model used to compress conversation history',
      title: 'Conversation History Compression Assistant',
    },
    queryRewrite: {
      label: 'Model',
      modelDesc: 'Specify the model used to optimize user inquiries',
      title: 'Knowledge Base Question Rewriting Assistant',
    },
    thread: {
      label: 'Model',
      modelDesc: 'The model designated for automatic renaming of subtopics',
      title: 'Subtopic Auto-Naming Assistant',
    },
    title: 'System Assistants',
    topic: {
      label: 'Model',
      modelDesc: 'Model designated for automatic topic renaming',
      title: 'Topic Auto-Naming Assistant',
    },
    translation: {
      label: 'Model',
      modelDesc: 'Specific model for translate message',
      title: 'Message Translation Assistant',
    },
  },
  tab: {
    about: 'About',
  ...
  tools: {
    ...
    notInstalledWarning:
      'This plugin is not currently installed, which may affect assistant functionality.',
    plugins: {
      enabled: 'Enabled: {{num}}',
      groupName: 'Plugins',
