export default {
  builtins: {
    'lobe-agent-builder': {
      apiName: {
        ...
        getPrompt: 'Get System Prompt',
        searchMarketTools: 'Search Plugin Market',
        searchOfficialTools: 'Search Official Tools',
        setModel: 'Set Model',
        setOpeningMessage: 'Set Opening Message',
        setOpeningQuestions: 'Set Opening Questions',
        togglePlugin: 'Toggle Plugin',
        updateChatConfig: 'Update Chat Config',
        updateConfig: 'Update Configuration',
        updateMeta: 'Update Metadata',
        updatePrompt: 'Update System Prompt',
      },
      title: 'Agent Builder',
    },
    'lobe-group-agent-builder': {
      apiName: {
        ...
        searchMarketTools: 'Search Plugin Marketplace',
    ...
    'lobe-group-management': {
      apiName: {
        ...
        createAgent: 'Add Team Member',
        createWorkflow: 'Plan Workflow',
        executeTask: 'Execute Task',
        getAgentInfo: 'Get Member Info',
        interrupt: 'Interrupt Task',
        inviteAgent: 'Invite Member',
        removeAgent: 'Remove Member',
        searchAgent: 'Find Expert',
        speak: 'Assign Speaker',
    ...
    'lobe-gtd': {
      apiName: {
        clearTodos: 'Clear Tasks',
        completeTodos: 'Complete Tasks',
        createPlan: 'Create Plan',
        createTodos: 'Create Tasks',
        removeTodos: 'Delete Tasks',
        updatePlan: 'Update Plan',
        updateTodos: 'Update Tasks',
      },
      title: 'GTD Tool',
    },
    'lobe-knowledge-base': {
      apiName: {
        readKnowledge: 'Read Knowledge Base',
    ...
    'lobe-page-agent': {
      apiName: {
        batchUpdate: 'Batch Update Nodes',
        ...
        initPage: 'Initialize Document',
        insertTableColumn: 'Insert Table Column',
        ...
        setImageAlt: 'Set Image Alt Text',
        splitNode: 'Split Node',
        toggleListType: 'Toggle List Type',
        unwrapNode: 'Unwrap Node',
        updateNode: 'Update Node',
        wrapNodes: 'Wrap Nodes',
      },
      title: 'Document',
    },
    'lobe-web-browsing': {
  ...
  detailModal: {
    ...
    emptyState: {
      description:
        'Please install this plugin first to view its capabilities and configuration options',
  ...
  dev: {
    confirmDeleteDevPlugin:
      'This local plugin will be deleted and cannot be recovered. Do you want to delete this plugin?',
    customParams: {
      useProxy: {
        label:
          'Install via Proxy (If you encounter cross-origin access errors, try enabling this option and reinstalling)',
      },
    },
    ...
    modalDesc:
      'After adding a custom plugin, it can be used for plugin development verification or directly in conversations. For plugin development, please refer to the <1>Development Documentation↗</>.',
    openai: {
  ...
  empty: {
    description:
      'The plugin store is full of powerful tools waiting to be discovered. Visit the store to start exploring.',
    search: 'No matching plugins found',
    title: 'No plugins available',
  },
  error: {
    fetchError:
      'Failed to request the manifest link, please ensure the link is valid and allows cross-origin access',
    installError: 'Plugin {{name}} installation failed',
    manifestInvalid:
      'Manifest does not comply with specifications, validation result: \n\n {{error}}',
  ...
  inspector: {
    ...
    orphanedToolCall:
      "This tool call message may have become orphaned due to an unexpected issue, which could affect the Agent's normal operation. Please remove it.",
  ...
  mcpEmpty: {
    deployment: 'No deployment options available',
    prompts: 'This plugin has no prompts',
    resources: 'This plugin has no resources',
    tools: 'This plugin has no tool capabilities',
  },
  mcpInstall: {
    CHECKING_INSTALLATION: 'Checking installation environment...',
    COMPLETED: 'Installation completed',
    CONFIGURATION_REQUIRED:
      'Please complete the relevant configuration before continuing installation',
    ...
    configurationDescription:
      'This MCP plugin requires configuration parameters to function properly, please fill in the necessary information',
    configurationRequired: 'Configure Plugin Parameters',
    continueInstall: 'Continue Installation',
    dependenciesDescription:
      'This plugin requires the following system dependencies to work properly. Please install the missing dependencies as instructed, then click recheck to continue installation.',
  ...
  protocolInstall: {
    ...
    custom: {
      ...
      security: {
        description:
          'This plugin is not officially verified, installation may pose security risks! Please ensure you trust the plugin source.',
    ...
    marketplace: {
      ...
      unverified: {
        ...
        warning:
          'This plugin is from an unverified third-party community. Please ensure you trust the source before installing.',
      },
      verified: 'Verified',
    },
    messages: {
    ...
    official: {
      ...
      description:
        'This plugin is developed and maintained by LobeHub official team, has undergone strict security review, safe to use.',
    ...
    warning:
      '⚠️ Please confirm you trust the source of this plugin. Malicious plugins may harm your system security.',
  },
  search: {
    config: {
      addKey: 'Add Key',
    ...
    crawPages: {
      ...
      detail: {
        ...
        raw: 'Raw Text',
        tooLong:
          'Text content is too long, only the first {{characters}} characters are kept in the conversation context, the rest are excluded',
      },
      meta: {
    ...
    searchxng: {
      ...
      unconfiguredDesc:
        'Please contact administrator to complete SearchXNG search engine configuration to start online search',
  ...
  settings: {
    ...
    envConfigDescription:
      'These configurations will be passed as environment variables to the MCP server process at startup',
    httpTypeNotice: 'HTTP type MCP plugins currently have no environment variables to configure',
    indexUrl: {
      title: 'Community Index',
      tooltip:
        'Online editing is not supported yet, please set via environment variables during deployment',
    },
    messages: {
    ...
    modalDesc:
      'After configuring the plugin community address, you can use a custom plugin community.',
    rules: {
    ...
    title: 'Plugin Community Settings',
  },
  ...
  store: {
    actions: {
      ...
      confirmUninstall:
        'This plugin will be uninstalled and its configuration cleared. Please confirm your action.',
      detail: 'Details',
      install: 'Install',
