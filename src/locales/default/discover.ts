export default {
  assistants: {
    ...
    details: {
      capabilities: {
        knowledge: {
          desc: 'This assistant includes the following knowledge bases to help answer more questions.',
    ...
    downloads: 'Downloads',
    empty: {
      description: 'Try adjusting the filters or visit the community to discover more assistants',
      search: 'No matching assistants found',
      title: 'No assistants available',
    },
    list: 'Assistant List',
    marketSource: {
      label: 'Switch Community Source',
    ...
    status: {
      archived: {
        reasons: {
          official:
            'The assistant was removed by the platform due to security, political, or other concerns.',
          owner: 'The assistant was voluntarily removed or archived by its developer.',
        },
        subtitle:
          "The assistant you're trying to access has been archived for one of the following reasons:",
        title: 'Assistant Archived',
      },
      backToMarket: 'Back to Assistant Community',
      deprecated: {
        reasons: {
          official:
            'The assistant was removed by the platform due to security, political, or other concerns.',
        ...
        subtitle:
          "The assistant you're trying to access has been rejected for one of the following reasons:",
      ...
      unpublished: {
        subtitle:
          'The assistant you are trying to access is currently under version review. If you have any questions, please copy the link and send it to <email>support@lobehub.com</email> for assistance.',
  ...
  createGuide: {
    func1: {
      desc1:
        'Access the settings page for the assistant you want to submit through the settings in the upper right corner of the conversation window;',
      desc2: 'Click the submit to Assistant Community button in the top right corner.',
      tag: 'Method One',
  ...
  filterBy: {
    ...
    other: {
      ...
      withKnowledge: 'Includes Knowledge Bases',
  ...
  home: {
    communityAgents: 'Community Assistants',
  ...
  mcp: {
    ...
    hero: {
      ...
      title: 'Open Source MCP Community for AI',
    },
    sorts: {
  ...
  mcpEmpty: {
    ...
    search: 'No matching MCP servers found',
  ...
  models: {
    ...
    empty: {
      description: 'Try adjusting the filters to see more models',
      search: 'No matching models found',
  ...
  providers: {
    ...
    empty: {
      description: 'Try adjusting the filters to see more providers',
      search: 'No matching providers found',
  ...
  user: {
    ...
    login: 'Become a Creator',
    logout: 'Logout',
    myProfile: 'My Profile',
    noAgents: 'This user has not published any agents yet',
    publishedAgents: 'Created Assistants',
    website: 'Website',
  },
};
