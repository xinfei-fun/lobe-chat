export default {
  ...
  betterAuth: {
    ...
    signup: {
      ...
      submit: 'Sign Up',
      subtitle: 'Start your Agents collaboration space',
  ...
  profile: {
    authorizations: {
      ...
      revoke: {
        ...
        title: 'Revoke authorization for {{name}}?',
      },
    ...
    interests: 'Interests',
    interestsAdd: 'Add',
    interestsPlaceholder: 'Enter an interest',
    password: 'Password',
  ...
  signin: {
    subtitle: 'Sign up or log in to your {{appName}} account',
    title: 'For Agents collaboration',
  },
  signout: 'Log Out',
  signup: 'Sign Up',
  stats: {
