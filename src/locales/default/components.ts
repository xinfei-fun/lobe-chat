export default {
  ...
  EmojiPicker: {
    ...
    draggerDesc: 'Click or drag an image here to upload',
    emoji: 'Emoji Avatar',
    fileTypeError: 'Please upload a valid image file',
    upload: 'Upload Avatar',
    uploadBtn: 'Crop and Upload',
  },
  FileManager: {
    actions: {
      addToKnowledgeBase: 'Add to Knowledge Base',
      addToOtherKnowledgeBase: 'Add to Another Knowledge Base',
      ...
      confirmRemoveFromKnowledgeBase:
        'You are about to remove {{count}} selected file(s) from the knowledge base. The files will still be accessible in All Files. Please confirm your action.',
      copyUrl: 'Copy Link',
  ...
  knowledgeBase: {
    empty: {
      description: 'Create a knowledge base to organize and manage your resources',
      search: 'No matching knowledge base found',
