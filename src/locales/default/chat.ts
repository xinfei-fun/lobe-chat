export default {
  ...
  agentBuilder: {
    installPlugin: {
      ...
      clickApproveToInstall: 'Click "Approve" to install this plugin',
    ...
    title: 'Assistant Builder Expert',
    welcome:
      "Tell me about your needs and scenarios—your professional partner is here to help.\n\nWhether it's writing, coding, or data analysis, I can help you build a personalized assistant!",
  },
  agentDefaultMessage:
    'Hello, I am **{{name}}**. You can start a conversation with me right away, or you can go to [Assistant Settings]({{url}}) to complete my information.',
  ...
  confirmRemoveChatGroupItemAlert:
    'This group will be deleted. Team members will not be affected. Please confirm your action.',
  confirmRemoveGroupItemAlert:
    'You are about to delete this group. After deletion, its assistants will be moved to the default list. Please confirm your action.',
  confirmRemoveGroupSuccess: 'Group deleted successfully',
  confirmRemoveSessionItemAlert:
    'You are about to delete this assistant. Once deleted, it cannot be retrieved. Please confirm your action.',
  ...
  emptyAgentAction: 'Create Assistant',
  extendParams: {
  ...
  groupWizard: {
    ...
    host: {
      ...
      title: 'Enable Host',
      tooltip:
        "If the team host is disabled, you'll need to manually @mention members to get their responses",
    },
  ...
  knowledgeBase: {
    ...
    disabled:
      'The current deployment mode does not support knowledge base conversations. To use this feature, please switch to a server-side database deployment or use the {{cloud}} service.',
    library: {
      action: {
        add: 'Add',
        detail: 'Details',
    ...
    relativeFilesOrLibraries: 'Related Files/Libraries',
    title: 'Knowledge Base',
    uploadGuide: "Uploaded files can be viewed in the 'Resources' section.",
    viewMore: 'View More',
  },
  memberSelection: {
    addMember: 'Add Member',
  ...
  messages: {
    ...
    modelCard: {
      ...
      creditTooltip:
        'For counting purposes, we convert $1 to 1M credits; for example, $3/M tokens can be converted to 3 credits/token.',
      pricing: {
  ...
  newAgent: 'Create Assistant',
  newGroupChat: 'Create Group Chat',
  newPage: 'Create Document',
  noAgentsYet: 'This group has no members yet. Click the + button to invite assistants.',
  ...
  pageCopilot: {
    ...
    welcome:
      "**Make every word count.**\n\nWhether you're drafting, rewriting, or polishing, I'll help make your writing clearer, more natural, and more persuasive.",
  },
  pin: 'Pin',
  pinOff: 'Unpin',
  rag: {
  ...
  sessionGroup: {
    ...
    confirmRemoveGroupAlert:
      'This group is about to be deleted. After deletion, the assistants in this group will be moved to the default list. Please confirm your operation.',
    ...
    noMatchingAgents: 'No matching assistants found',
    noSelectedAgents: 'Please select assistants',
    rename: 'Rename Group',
    renameSuccess: 'Renamed successfully',
    searchAgents: 'Search assistants',
    selectedAgents: 'Selected assistants ({{count}})',
  ...
  task: {
    activity: {
      ...
      gotResult: 'Tool result received',
      toolCalling: 'Calling {{toolName}}...',
      toolResult: '{{toolName}} result received',
    },
    metrics: {
      stepsShort: 'steps',
      toolCallsShort: 'tool uses',
    },
    status: {
  ...
  tool: {
    intervention: {
      ...
      rejectReasonPlaceholder:
        'Providing a reason will help the Agent understand and improve future actions',
  ...
  toolAuth: {
    ...
    hint: 'Without authorization, these tools may not work properly, which could cause the assistant to have limited functionality or errors.',
    signIn: 'Sign In',
    title: 'This assistant uses tools that require authorization',
  },
  topic: {
